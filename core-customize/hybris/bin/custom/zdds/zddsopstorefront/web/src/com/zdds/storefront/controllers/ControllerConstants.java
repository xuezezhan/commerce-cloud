 ...
 */
package com.zdds.storefront.controllers;
...
public interface ControllerConstants
{
	...
	interface Views
	{
		...
		interface Pages
		{
			String LOGIN_PAGE = "pages/login/login";
			String INDEX = "pages/frontend/index";
			String B2BUNITTIMEOUT = "pages/frontend/b2bUnitTimeOut";
