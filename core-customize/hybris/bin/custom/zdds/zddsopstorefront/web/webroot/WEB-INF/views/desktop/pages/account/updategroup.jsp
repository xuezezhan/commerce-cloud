...
<head>
    ...
    <script src="${commonResourcePath}/js/account/updategroup.js" charset="utf-8"></script>
</head>
            ...
            <div class="layui-colla-content layui-show">
                    <div class="layui-form-item">
                        ...
                        <div class="layui-col-xs3">
                            ...
                            <div class="layui-input-block">
                                <input type="text" name="name" id="name" required  lay-verify="required" placeholder="权限组名称" autocomplete="off" class="layui-input">
                            </div>
                        </div>
                        <div class="layui-col-xs3">
                            <label class="layui-form-label">权限组描述</label>
                            <div class="layui-input-block">
                                <input type="text" name="description" id="description" required  placeholder="权限组描述" autocomplete="off" class="layui-input">
                            </div>
                        </div>
                    </div>
            </div>
