...
public class WebHttpSessionRequestCacheUnitTest
{
	...
	public void testCalcRedirectUrlWithEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/zddsopstorefront/electronics/en",
						"https://electronics.local:9002/zddsopstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/zddsopstorefront/electronics/en",
						"https://electronics.local:9002/zddsopstorefront/electronics/en/"));
	...
	public void testCalcRedirectUrlWithMismatchEncodingAttrs()
	{
		assertEquals(
				"electronics/en",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/zddsopstorefront/electronics/ja/Y/Z",
						"https://electronics.local:9002/zddsopstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/zddsopstorefront/electronics/en",
						"https://electronics.local:9002/zddsopstorefront/electronics/en/"));
	}
	...
	public void testCalcRedirectUrlWithoutEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/zddsopstorefront",
						"https://electronics.local:9002/zddsopstorefront"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/zddsopstorefront",
						"https://electronics.local:9002/zddsopstorefront/"));
	...
	public void testCalcRedirectUrlWithEncodingAttrsServletPath()
	{
		assertEquals(
				...
				executeCalculateRelativeRedirectUrl("electronics/en", "/zddsopstorefront/electronics/en",
						"https://electronics.local:9002/zddsopstorefront/electronics/en/Open-Catalogue/Cameras/Digital-Cameras/c/575"));
	}
