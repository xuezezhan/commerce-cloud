...
public class DefaultZddsopfacadesService implements ZddsopfacadesService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultZddsopfacadesService.class);
	...
	{
		return DefaultZddsopfacadesService.class.getResourceAsStream("/zddsopfacades/sap-hybris-platform.png");
	}
