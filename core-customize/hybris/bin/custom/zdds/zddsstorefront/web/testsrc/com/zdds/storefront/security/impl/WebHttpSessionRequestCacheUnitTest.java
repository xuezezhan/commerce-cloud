...
public class WebHttpSessionRequestCacheUnitTest
{
	...
	public void testCalcRedirectUrlWithEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/zddsstorefront/electronics/en",
						"https://electronics.local:9002/zddsstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/zddsstorefront/electronics/en",
						"https://electronics.local:9002/zddsstorefront/electronics/en/"));
	...
	public void testCalcRedirectUrlWithMismatchEncodingAttrs()
	{
		assertEquals(
				"electronics/en",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/zddsstorefront/electronics/ja/Y/Z",
						"https://electronics.local:9002/zddsstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/zddsstorefront/electronics/en",
						"https://electronics.local:9002/zddsstorefront/electronics/en/"));
	}
	...
	public void testCalcRedirectUrlWithoutEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/zddsstorefront",
						"https://electronics.local:9002/zddsstorefront"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/zddsstorefront",
						"https://electronics.local:9002/zddsstorefront/"));
	...
	public void testCalcRedirectUrlWithEncodingAttrsServletPath()
	{
		assertEquals(
				...
				executeCalculateRelativeRedirectUrl("electronics/en", "/zddsstorefront/electronics/en",
						"https://electronics.local:9002/zddsstorefront/electronics/en/Open-Catalogue/Cameras/Digital-Cameras/c/575"));
	}
