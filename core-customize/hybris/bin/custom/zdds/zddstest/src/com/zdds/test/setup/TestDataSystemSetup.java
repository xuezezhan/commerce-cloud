...
import com.zdds.test.constants.ZddsTestConstants;
import com.zdds.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = ZddsTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/zddstest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/zddstest/import/reviews.impex");

			LOG.info("Creating Test Payment Subscriptions...");
			getAcceleratorTestOrderData().createPaymentInfos();

			LOG.info("Creating CS Tickets...");
			importImpexFile(context, "/zddstest/import/cstickets.impex");
			...
			importImpexFile(context, "/zddstest/import/csquotes.impex");
		}
	}
}
